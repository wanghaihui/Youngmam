 ...
 */
public class LoadMoreDefaultFooterView2 extends RelativeLayout implements LoadMoreUIHandler {
    private static final String TAG = LoadMoreDefaultFooterView.class.getSimpleName();

    private TextView mTextView;

    public LoadMoreDefaultFooterView2(Context context) {
        this(context, null);
    }

    public LoadMoreDefaultFooterView2(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LoadMoreDefaultFooterView2(Context context, AttributeSet attrs, int defStyle) {
