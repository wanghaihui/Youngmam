...
public abstract class LoadMoreContainerBase extends LinearLayout implements LoadMoreContainer {
    ...
    public void useDefaultFooter2() {
        LoadMoreDefaultFooterView2 footerView = new LoadMoreDefaultFooterView2(getContext());
        footerView.setVisibility(GONE);
        setLoadMoreView(footerView);
        setLoadMoreUIHandler(footerView);
    }
    ...
    private void tryToPerformLoadMore() {
        Log.d(TAG, "try to perform load more");
    ...
    private void onReachBottom() {
        ...
        if (mAutoLoadMore) {
            Log.d(TAG, "on Reach Bottom auto load more");
