...
public class DateValidator extends Validator {
    ...
    public DateValidator(String errorMessage, String format) {
        super(errorMessage);
        formats = TextUtils.isEmpty(format) ? new String[]{"DefaultDate","DefaultTime","DefaultDateTime"} : format.split(";") ;
    }
