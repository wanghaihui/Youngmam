...
import com.xiaobukuaipao.youngmam.filter.util.Point2D;
import com.xiaobukuaipao.youngmam.filter.util.UIUtils;

/**
 * Created by xiaobu1 on 15-9-11.
 */
public class StickerHighlightView implements EditableDrawable.OnSizeChange {

    private static final String TAG = StickerHighlightView.class.getSimpleName();
    ...
    public void setScaleable(boolean scaleable) {
        ...
        if (scaleable) {
            mAnchorRotate = HuaYoungApplication.getInstance().getResources().getDrawable(R.drawable.aviary_resize_knob);
        } else {
            mAnchorRotate = null;
        }
    }
    ...
    public void setDeleteable(boolean deleteable) {
        if (deleteable) {
            mAnchorDelete = HuaYoungApplication.getInstance().getResources().getDrawable(R.drawable.aviary_delete_knob);
        } else {
            mAnchorDelete = null;
        }
    }
     ...
     * @param content
     */
    public StickerHighlightView(ImageView context, int styleId, FeatherDrawable content, String stickerId, int stickerType) {
        mContent = content;
    ...
    public void draw(final Canvas canvas) {
        ...
        if (is_selected || is_focused) {
            ...
            if (mShowAnchors) {
                ...
                outlinePaint.setStrokeWidth(HuaYoungApplication.getInstance().dp2px(1));
    ...
    public void onMouseMove(int edge, MotionEvent event2, float dx, float dy) {
        ...
        if (edge == MOVE) {
            ...
            Log.d(TAG, "x: " + xDelta + ", y: " + yDelta + ", final: " + delta);
    ...
    public void invalidate() {
        ...
        Log.d(TAG, "computeLayout: " + mDrawRect);
