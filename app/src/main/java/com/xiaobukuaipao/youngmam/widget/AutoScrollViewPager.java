 ...
 */
public class AutoScrollViewPager extends ScaleViewPager {
    ...
    private void setViewPagerScroller() {
        try {
            Field scrollerField = ScaleViewPager.class.getDeclaredField("mScroller");
            scrollerField.setAccessible(true);
            Field interpolatorField = ScaleViewPager.class.getDeclaredField("sInterpolator");
