...
public class MaterialAlertDialog extends android.app.Dialog {
    ...
    public MaterialAlertDialog(Context context,String title, String message, String rightShow) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.material_alert_dialog);
    ...
    @Override
    public void dismiss() {
        MaterialAlertDialog.super.dismiss();
